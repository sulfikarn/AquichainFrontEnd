...
( function () {
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		function onPointerMove( event ) {
			...
			xDifference += pointer.movementX;
			yDifference += pointer.movementY;
		...
		function intersectObjects( pointer, objects ) {
			...
			var x = ( pointer.clientX + xDifference - rect.left ) / rect.width;
			var y = ( pointer.clientY + yDifference - rect.top ) / rect.height;
